...
public abstract class AbstractCarobotWriteDigitalBlock extends TranslatorBlock {

  AbstractCarobotWriteDigitalBlock(Long blockId, Translator translator, String codePrefix,
  ...
  public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
    ...
    if (translatorBlock instanceof NumberBlock
        || translatorBlock instanceof CarobotOutputPortBlock) {
